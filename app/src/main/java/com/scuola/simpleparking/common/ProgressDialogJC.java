...
public class ProgressDialogJC extends Dialog {
    ...
    static ProgressDialogJC instance;
    View view;
    TextView tvMessage;
    ImageView ivSuccess;
    ImageView ivFailure;
    ...
    public static ProgressDialogJC getInstance(Context context) {
        if (instance == null) {
            instance = new ProgressDialogJC(context);
        }
        return instance;
    }

    public ProgressDialogJC(Context context) {
